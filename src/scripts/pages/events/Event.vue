      ...
      handleScroll (event) {
        if( this.$refs.eventContent.clientHeight > this.$refs.poster.clientHeight){
          ...
          if( window.pageYOffset > 20 ){
            // console.log( window.innerHeight, window.pageYOffset, this.footerHeight, this.$refs.poster.clientHeight  );
            // console.log( window.innerHeight - window.pageYOffset + this.footerHeight + 50 - this.$refs.poster.clientHeight );
            if( window.innerHeight - window.pageYOffset + this.footerHeight + 10 - this.$refs.poster.clientHeight < 0){
              this.negativeAux = window.innerHeight - window.pageYOffset + this.footerHeight + 10 - this.$refs.poster.clientHeight;
            }else{
              this.negativeAux = 0
            }
